...
NOTE: For now, the package has unresolved Namespace-problems ('smooth.construct' is exported as a generic function by both 'mgcv' and 'bamlss'). Installation of this package via Github should work, as well as using the package for the analysis and simulation. A fix for the Namespace problem is under way.
